...
from rag_researcher.agent.policies.guardrail import evaluate_guardrail
...
from rag_researcher.generation.direct import generate_direct_answer
from rag_researcher.generation.prompt import build_rag_prompt
from rag_researcher.agent.state import AgentState
from rag_researcher.agent.state_utils import (
...
from rag_researcher.observability import get_langfuse_tracer
from rag_researcher.observability.trace_summary import compact_preview, compact_search_result
from rag_researcher.retrieval.search import hybrid_search
from rag_researcher.retrieval.vector_store import SearchResult
from rag_researcher.runtime import get_bge_reranker, get_answer_generator

DEFAULT_TOP_K = 3
GIVE_UP_MESSAGE = "There is not enough information in the database to answer this question."
GUARDRAIL_MESSAGE = "Please enter a more specific and clear question about the document."
        ...
        if not generator.is_configured():
            ...
            with get_langfuse_tracer().generation(
                ...
                try:
                    ...
                    error_msg = (
                        f"The AI generator is temporarily unavailable ({type(exc).__name__}). "
