...
from rag_researcher.generation.service import generate_answer
from rag_researcher.retrieval.search import SearchStrategy, search_chunks
...
def render_benchmark_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# RAG_researcher Benchmark Report",
        "",
