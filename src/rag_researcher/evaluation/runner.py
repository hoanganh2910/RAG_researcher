...
from rag_researcher.evaluation.dataset import EvaluationCase, load_evaluation_dataset
from rag_researcher.evaluation.metrics import evaluate_ranked_results
from rag_researcher.retrieval.service import RetrievalRequest, RetrievalService
...
def render_markdown_report(report: dict[str, object]) -> str:
    ...
    lines = [
        "# RAG_researcher Retrieval Evaluation",
        "",
