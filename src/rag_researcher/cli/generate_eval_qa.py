...
from rag_researcher.evaluation.qa_generator import generate_eval_qa
...
def main() -> None:
    ...
    parser.add_argument("--paper-id", type=int, default=None, help="Optional paper ID")
    parser.add_argument("--num-questions", type=int, default=20)
    parser.add_argument("--output", type=Path, default=Path("data/eval/qa_gold.json"))
