...
from rag_researcher.pipeline.steps import fetch_and_store_papers, store_papers
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Fetch arXiv paper metadata into RAG_researcher")
    parser.add_argument(
        "--query",
