...
from rag_researcher.chunking.agentic_chunker import chunk_agentic_documents
...
from rag_researcher.cli.rebuild_paper import annotate_fixed_chunk_sections
from rag_researcher.config import settings
from rag_researcher.evaluation.qa_generator import qa_from_chunk
...
from rag_researcher.papers.arxiv_client import ARXIV_API_URL, parse_arxiv_feed
from rag_researcher.papers.docling_parser import parse_pdf_with_docling
from rag_researcher.papers.models import PaperFile, PaperMetadata, structured_paper_to_document
...
from rag_researcher.pipeline.steps import embed_chunks, index_embeddings
...
def main() -> None:
    ...
    parser.add_argument("--papers-dir", type=Path, default=Path("E:/rag_researcher-data/papers"))
