...
from rag_researcher.papers.downloader import safe_arxiv_id
from rag_researcher.papers.models import PaperFile, PaperMetadata, StoredPaper
...
DEFAULT_OUTPUT_DIR = Path("E:/rag_researcher-data/papers")
DEFAULT_CATEGORIES = [
    "cs.AI",
    "cs.CL",
    "cs.CV",
