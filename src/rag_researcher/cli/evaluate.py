...
from rag_researcher.evaluation.runner import run_retrieval_evaluation
from rag_researcher.evaluation.retrieval_eval import evaluate_retrieval, load_eval_dataset
from rag_researcher.evaluation.framework import run_benchmark
...
def main() -> None:
    load_dotenv()
    parser = argparse.ArgumentParser(description="Evaluate RAG_researcher retrieval")
