...
from rag_researcher.cli.formatters import print_search_response, print_trace_summary
from rag_researcher.config import settings
from rag_researcher.observability.trace_summary import TraceSummary
from rag_researcher.retrieval.search import search_with_strategy
from rag_researcher.retrieval.service import normalize_strategy


def main() -> None:
    load_dotenv()

    parser = argparse.ArgumentParser(description="Search RAG_researcher chunks")
