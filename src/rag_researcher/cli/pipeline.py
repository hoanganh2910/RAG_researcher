...
from rag_researcher.papers.downloader import DEFAULT_PAPER_DIR
from rag_researcher.pipeline.runner import (
    PipelineConfig,
    run_knowledge_pipeline,
    run_scheduled_once,
)
from rag_researcher.runtime import get_elasticsearch_vector_store
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run the RAG_researcher knowledge pipeline")
...
def schedule_pipeline(args: argparse.Namespace) -> None:
    ...
    print("RAG_researcher pipeline scheduler started")
    scheduler.start()
