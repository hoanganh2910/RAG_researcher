...
from rag_researcher.runtime import get_redis_cache
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Reset RAG_researcher local data and evaluation state")
    ...
    reset_elasticsearch()
    reset_redis()
    print("RAG_researcher data reset complete.")
