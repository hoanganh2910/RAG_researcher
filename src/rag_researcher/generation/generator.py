...
DEFAULT_SYSTEM_PROMPT = (
    "You are RAG_researcher's RAG answer generator. Answer only from the provided context."
)
    ...
    def generate(
        ...
        *,
        ...
        if not self.is_configured():
            raise ValueError(
                "DEEPSEEK_API_KEY is not configured. Add it to .env before running rag_researcher-ask."
            )
        ...
        with tracer.generation(
            ...
            metadata={"provider": "deepseek", "stream": False, "json_mode": json_mode},
        ) as observation:
...
class OllamaAnswerGenerator(OllamaDecisionGenerator):
    def generate(
        self,
        prompt: str,
        system_prompt: str = DEFAULT_SYSTEM_PROMPT,
        *,
        ...
        return super().generate(prompt, system_prompt, json_mode=json_mode)
