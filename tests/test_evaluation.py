...
from rag_researcher.evaluation.metrics import evaluate_ranked_results
from rag_researcher.evaluation.runner import run_retrieval_evaluation
from rag_researcher.retrieval.search import SearchResponse
...
def test_retrieval_evaluation_writes_json_and_markdown(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("rag_researcher.evaluation.runner.RetrievalService.search", fake_search)
