...
import rag_researcher.cli.ask as ask_cli
from app.main import app
from rag_researcher.generation import service as generation_service
from rag_researcher.retrieval.search import SearchResponse as RetrievalSearchResponse
...
def test_ask_endpoint(monkeypatch) -> None:
    ...
    monkeypatch.setattr(generation_service, "get_answer_generator", lambda: FakeGenerator())
...
def test_ask_cli_uses_generation_service_flags(monkeypatch, capsys) -> None:
    ...
    monkeypatch.setattr("sys.argv", ["rag_researcher-ask", "LangGraph", "--top-k", "2"])
