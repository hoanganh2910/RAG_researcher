...
import rag_researcher.retrieval.search as search_module
from rag_researcher.reranking.reranker import BGEReranker
from rag_researcher.retrieval.hyde import build_hyde_search_text
from rag_researcher.retrieval.search import SearchResponse, fuse_rrf_sources
from rag_researcher.retrieval.indexer import build_indexing_result
from rag_researcher.retrieval.vector_store import ElasticsearchVectorStore, SearchResult, dedupe_search_results
...
def test_hyde_falls_back_to_original_query_without_local_model(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "rag_researcher.retrieval.hyde.get_ollama_decision_generator",
