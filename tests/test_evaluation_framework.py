...
from rag_researcher.evaluation.framework import (
...
def test_run_benchmark_writes_variant_report(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("rag_researcher.evaluation.framework.search_chunks", fake_search_chunks)
...
def load_gold_qa_from_payload(payload):
    from rag_researcher.evaluation.framework import parse_gold_item
