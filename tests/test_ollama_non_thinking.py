...
from rag_researcher.chunking.agentic_chunker import OllamaChunkPlanner
from rag_researcher.generation.generator import OllamaDecisionGenerator
...
def test_chunk_planner_disables_thinking(monkeypatch) -> None:
    ...
    monkeypatch.setattr("rag_researcher.chunking.agentic_chunker.requests.post", fake_post)
