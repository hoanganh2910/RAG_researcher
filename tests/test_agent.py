import rag_researcher.agent.policies.grader as grader_policy
import rag_researcher.agent.policies.guardrail as guardrail_policy
import rag_researcher.agent.policies.rewriter as rewriter_policy
import rag_researcher.agent.policies.router as router_policy
import pytest
...
from rag_researcher.cli.agent_test import main as agent_test_main
...
def test_guardrail_uses_qwen_for_semantic_decision(monkeypatch) -> None:
    ...
    decision = guardrail_policy.evaluate_guardrail("xyz quantum entanglement simulation")
